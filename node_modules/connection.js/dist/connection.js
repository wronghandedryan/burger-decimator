 ...
 * utils.js
 */
var utils, childChild, utlIsObject, utlIsArray, utlCompanionDeepMerge, stringspaceUtils, stringspaceStringspace, eventEmitterEventEmitter, assistCapitalize, utlIsUndefined, utlIsEmpty, utlExtend, miniStoreMiniStore, connection;
utils = {
  /*
   * @private
   * @memberof utils
...
connection = function (require) {
  ...
  return child(MiniStore, {
    ...
    constructor: function (settings) {
      ...
      _.bindAll(this, '_startHeartbeat', '_stopHeartbeat', '_onOnline', '_onOffline', '_onHeartbeatError', '_onHeartbeatSuccess', '_onChangeStatus');
    ...
    _onOnline: function (evt) {
      return this.settings.ping ? this._startHeartbeat() : this.set('status', 1);
    },
    /*
     * @private
     * @memberof Connection
